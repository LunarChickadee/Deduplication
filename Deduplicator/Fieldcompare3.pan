...
ML_merge_list="adc,Bf,C#,CG,Cit,City,Code,Con,email,EntrySequence,Group,inqcode,M?,MAd,Mem?,Modified,Notes,Outstanding,phone,RedFlag,resale,S,SAd,SpareNumb1,SpareNumb2,SpareText1,SpareText2,SpareText3,St,Sta,T,TaxEx,Updated,UPS?,Z,Zip"
...
window "DeDuplicator"
length_count=arraysize(on_both,",")
merge_counter=1

loop
    window "DeDuplicator"
    field (array(on_both,merge_counter,","))
        to_merge=«»
...
until merge_counter=arraysize(on_both,",")+1
