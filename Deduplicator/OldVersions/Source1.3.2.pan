...
arrayselectedbuild list_of_records, ¶,"",?(Flagged≠"", "RedFlagged!!!! Check Closely"+¶,"")+?(info("summary")>0, "Merged Preview is below:"+¶,"")+arrayrange(exportline(),1, 7,¬)+¶+arrayrange(exportline(),15, 20,¬)+¶+
...
arrayselectedbuild «C#»,delete_these_histories, ¶, ?(HasHistory="Yes", import(), "")



arrayselectedbuild «C#»,delete_these_MLs, ¶, «C#»


displaydata delete_these_histories+delete_these_MLs
